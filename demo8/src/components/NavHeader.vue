  ...
  <div class="navbar">
    ...
    <div class="navbar-right-container" style="display: flex;">
      <div class="navbar-menu-container">
        ...
        <span  v-text="nicName" v-if="nicName"></span>
        <a href="javascript:void(0)" class="navbar-link" v-if="!nicName" @click ="loginModalFlag=true">Login</a>
        <a href="javascript:void(0)" class="navbar-link" v-if="nicName" @click ="logOut">Logout</a>
              ...
              <div class="confirm-tips">
                ...
                <ul>
                  ...
                  <li class="regi_form_input noMargin">
                    ...
                    v-model="userPwd" class="regi_login_input regi_login_input_left login-input-no 
                    input_text" placeholder="Password" @keyup.enter="login">
                  </li>
                </ul>
              </div>
...
export default {
    ...
    data(){
        return{
            userName:'',
            userPwd:'',
            errorTip:false,     //帐号密码输入错误信息提示
            loginModalFlag:false ,  //实现遮罩
            nicName:''            //保存userName
        }
    },
    mounted(){
    ...
    methods:{
      checkLogin(){
        //检测登录状态，发送请求查看cookie里面是否有用户已登录的信息
         axios.get("/users/checkLogin").then((res)=>{
           let result = res.data;
           if(result.status == 0){
             this.nicName = result.result
           }
         })
       },
            login(){
              if(!this.userName||!this.userPwd){
                ...
                axios.post("/users/login",{
                  ...
                  if(result.status == 0){
                    ...
                    this.nicName = result.result.userName;
